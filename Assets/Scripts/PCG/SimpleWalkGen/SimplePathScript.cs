...
public class SimplePathScript
{
    ...
    public SimplePathScript(int radius)
    {
        this.radius = radius;
    }
    ...
    private void MoveLeft(ref GameObject current)
    {
        ...
        currentFloorIndex = SimpleWalkScript.corridorFloor.IndexOf(current);

        currentFloorIndex++;
        current = SimpleWalkScript.corridorFloor[currentFloorIndex];
    ...
    private void MoveUp(ref GameObject current)
    {
        ...
        current = SimpleWalkScript.corridorFloor[n];
    }
